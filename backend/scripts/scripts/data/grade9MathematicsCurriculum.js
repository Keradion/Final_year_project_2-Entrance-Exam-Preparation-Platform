 ...
 * Plus 7 Quiz records per chapter (7 MCQ problems each).
 */
  ...
  chapters: [
    {
      ...
      quizzes: [
        ...
        {
          topicIndex: 0,
          title: 'Unit 1 Quiz 6 — Mixed review',
          problems: [
            {
              questionText: 'Which statement is false?',
              choices: quizChoices(['∅ ⊆ ∅', '∅ ∈ ∅', '∅ ⊂ {1}', '{1} has one element']),
              correctAnswer: 'B',
              answerExplanation: 'Empty set is not an element of itself under typical grade-9 roster use.',
            },
            {
              questionText: '{x ∈ ℤ | x² = 4} equals',
              choices: quizChoices(['{4}', '{2}', '{−2, 2}', '{−4, 4}']),
              correctAnswer: 'C',
              answerExplanation: 'Both −2 and 2 square to 4.',
            },
            {
              questionText: 'If A = {2,4}, B = {1,2,3,4}, then A ∩ B =',
              choices: quizChoices(['{2,4}', '{1,3}', '{1,2,3,4}', '∅']),
              correctAnswer: 'A',
              answerExplanation: 'Common elements are 2 and 4.',
            },
            {
              questionText: 'The number of elements in {a, {a}} is:',
              choices: quizChoices(['1', '2', '3', '0']),
              correctAnswer: 'B',
              answerExplanation: 'Elements are a and the set {a}.',
            },
            {
              questionText: 'If U = {1…10}, odd numbers form set O. |O| =',
              choices: quizChoices(['4', '5', '6', '10']),
              correctAnswer: 'B',
              answerExplanation: '1,3,5,7,9 — five odds.',
            },
            {
              questionText: '(A′)′ equals',
              choices: quizChoices(['A', 'U', '∅', 'A′']),
              correctAnswer: 'A',
              answerExplanation: 'Double complement returns the original set.',
            },
            {
              questionText: 'N ∪ Z for usual ℕ ⊆ ℤ is:',
              choices: quizChoices(['ℕ', 'ℤ', '∅', 'ℚ only']),
              correctAnswer: 'B',
              answerExplanation: 'Union of naturals and all integers is ℤ.',
            },
          ],
        },
        {
          topicIndex: 2,
          title: 'Unit 1 Quiz 7 — Challenge',
          problems: [
            {
              questionText: 'If |A| = 10, |B| = 15, |A ∩ B| = 5, find |A ∪ B|:',
              choices: quizChoices(['30', '20', '25', '10']),
              correctAnswer: 'B',
              answerExplanation: '10 + 15 − 5 = 20.',
            },
            {
              questionText: 'If A = {x ∈ ℝ | 0 < x < 1} and B = {1/2}, then:',
              choices: quizChoices([
                'B ⊆ A',
                'A ⊆ B',
                'A ∩ B = ∅',
              ...
              correctAnswer: 'A',
              answerExplanation: '1/2 lies strictly between 0 and 1.',
            },
            {
              questionText: 'For finite U, |A′| equals:',
              choices: quizChoices(['|U| − |A|', '|A| − |U|', '|A ∩ U|', '|A| + |U|']),
              correctAnswer: 'A',
              answerExplanation: 'Complement size is universe minus set size.',
            },
            {
              questionText: 'A − B (set difference) equals:',
              choices: quizChoices(['A ∩ B', 'A ∩ B′', 'A ∪ B', 'A′ ∩ B']),
              correctAnswer: 'B',
              answerExplanation: 'Elements in A not in B: A ∩ B′.',
            },
            {
              questionText: 'If A ∪ B = A ∩ B for finite A, B, then:',
              choices: quizChoices(['A must equal B', '|A| = 0', 'B = ∅', 'Impossible']),
              correctAnswer: 'A',
              answerExplanation: 'Union equals intersection implies A = B.',
            },
            {
              questionText: 'Which pair can have |A ∪ B| = |A| + |B|?',
              choices: quizChoices([
                'Any A and B',
                'Disjoint A and B',
                'Always when |A| = |B|',
                'Never for finite sets',
              ]),
              correctAnswer: 'B',
              answerExplanation: 'If disjoint, intersection size is 0.',
            },
            {
              questionText: 'Power set of {m} has size:',
              choices: quizChoices(['1', '2', '3', '4']),
              correctAnswer: 'B',
              answerExplanation: 'Subsets are ∅ and {m}.',
            },
          ],
        },
      ],
...

    {
      ...
      quizzes: [
        ...
        {
          topicIndex: 0,
          title: 'Unit 2 Quiz 6 — Real numbers review',
          problems: [
            {
              questionText: 'Which number is rational?',
              choices: quizChoices(['√3', '√16', 'π', '√2 + √3']),
              correctAnswer: 'B',
              answerExplanation: '√16 = 4 is an integer, hence rational.',
            },
            {
              questionText: 'Multiplicative inverse of −2 is:',
              choices: quizChoices(['2', '−2', '−1/2', '1/2']),
              correctAnswer: 'C',
              answerExplanation: 'Product must be 1: (−2)(−1/2) = 1.',
            },
            {
              questionText: 'Additive inverse of 5/3 is:',
              choices: quizChoices(['−5/3', '5/3', '3/5', '−3/5']),
              correctAnswer: 'A',
              answerExplanation: 'Sum must be 0.',
            },
            {
              questionText: 'On the number line, −1 is:',
              choices: quizChoices(['Right of 0', 'Left of 0', 'Above 0', 'Not comparable']),
              correctAnswer: 'B',
              answerExplanation: 'Negatives lie to the left of zero.',
            },
            {
              questionText: 'If 0 < a < 1, then a² is:',
              choices: quizChoices(['Greater than a', 'Equal to a', 'Less than a', 'Negative']),
              correctAnswer: 'C',
              answerExplanation: 'Squaring a fraction between 0 and 1 reduces value.',
            },
            {
              questionText: 'Which is farthest from 0?',
              choices: quizChoices(['−11/10', '−1.05', '1', '−9/10']),
              correctAnswer: 'A',
              answerExplanation: '|−1.1| = 1.1 is largest.',
            },
            {
              questionText: 'Decimal form of 7/20 is:',
              choices: quizChoices(['0.35', '0.035', '3.5', '0.28']),
              correctAnswer: 'A',
              answerExplanation: '7 ÷ 20 = 0.35.',
            },
          ],
        },
        {
          topicIndex: 2,
          title: 'Unit 2 Quiz 7 — Number line & intervals',
          problems: [
            {
              questionText: 'Compound inequality −1 ≤ x < 2 in interval notation:',
              choices: quizChoices(['(−1, 2)', '[−1, 2)', '(−1, 2]', '[−1, 2]']),
              correctAnswer: 'B',
              answerExplanation: 'Include −1, exclude 2.',
            },
            {
              questionText: 'Which x satisfies both x > −2 and x ≤ 1?',
              choices: quizChoices(['x = −3', 'x = 0', 'x = 2', 'x = 1.5']),
              correctAnswer: 'B',
              answerExplanation: '0 lies in (−2, 1].',
            },
            {
              questionText: 'The inequality 4 ≤ x ≤ 4 describes:',
              choices: quizChoices(['All reals', 'The single value 4', 'An open interval', 'No solution']),
              correctAnswer: 'B',
              answerExplanation: 'Only x = 4 satisfies both bounds.',
            },
            {
              questionText: 'Which is equivalent to “x is at most 5”?',
              choices: quizChoices(['x ≥ 5', 'x ≤ 5', 'x = 5', 'x > 5']),
              correctAnswer: 'B',
              answerExplanation: '“At most” means less than or equal.',
            },
            {
              questionText: 'If x ∈ [2, 6], the length of this interval is:',
              choices: quizChoices(['4', '8', '3', '6']),
              correctAnswer: 'A',
              answerExplanation: '6 − 2 = 4.',
            },
            {
              questionText: 'Number line distance |π − 3| is approximately:',
              choices: quizChoices(['0.14', '3.14', '6.28', '0']),
              correctAnswer: 'A',
              answerExplanation: 'π ≈ 3.14, difference ≈ 0.14.',
            },
            {
              questionText: 'For a < b, the open interval (a, b) contains:',
              choices: quizChoices(['a and b', 'Neither endpoint', 'Only a', 'Only b']),
              correctAnswer: 'B',
              answerExplanation: 'Endpoints excluded in open interval.',
            },
          ],
        },
      ],
